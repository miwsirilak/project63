      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <!-- <h1 class="h4 mb-0 text-gray-800">{{Session::get('first_name')}}</h1> -->
            
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
          </div>
          <!-- <h1 class="h5 mb-0 text-gray-800">Piyarat Skin Clinic</h1> -->
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">{{'first_name'}}</div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800">เลื่อนวันนัด</div>
                        </div>
                      </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h6 mb-0 font-weight-bold text-gray-800">ยกเลิกวันนัด</div>
                    </div>
                    <div class="col-auto">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <div class="mt-4 text-center small">
        <span class="mr-2">
        <h6 class="m-0 font-weight-bold ">ความรู้เกี่ยวกับโรคผิวหนัง </h6>
          <!-- <i class=""></i> ความรู้เกี่ยวกับโรคผิวหนัง -->
        </span>
      </div>
    </div>
  </div>
